...
ADCSWTrigger.obj: F:/Dropbox/EE345L\ Class/EE445LTeachingMaterials/0000_Fall_2024/0000_Fall_2024_Lab/inc/ADCSWTrigger.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	...
	"C:/ti/ccs1280/ccs/tools/compiler/ti-cgt-arm_20.2.7.LTS/bin/armcl" -mv7M4 --code_state=16 --float_support=FPv4SPD16 -me --include_path="F:/Dropbox/EE345L Class/EE445LTeachingMaterials/0000_Fall_2024/0000_Fall_2024_Lab/Lab2" --include_path="C:/ti/ccs1280/ccs/tools/compiler/ti-cgt-arm_20.2.7.LTS/include" --define=ccs="ccs" --define=PART_TM4C123GH6PM -g --c99 --gcc --diag_warning=225 --diag_wrap=off --display_error_number --abi=eabi --preproc_with_compile --preproc_dependency="ADCSWTrigger.d_raw" $(GEN_OPTS__FLAG) "$<"
...
UART.obj: F:/Dropbox/EE345L\ Class/EE445LTeachingMaterials/0000_Fall_2024/0000_Fall_2024_Lab/inc/UART.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Building file: "$<"'
	@echo 'Invoking: Arm Compiler'
